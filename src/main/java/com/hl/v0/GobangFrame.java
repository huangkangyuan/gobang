...
public class GobangFrame extends JPanel implements GobangConfig {
    ...
    public void initUI() {
        ...
        jFrame.setTitle("五子棋");
        jFrame.setSize(UIWIDTH, UIHIGHTH);
        jFrame.setLocationRelativeTo(null);
        jFrame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        jFrame.setLayout(new BorderLayout());//设置顶级容器JFrame为BorderLayout框架布局
        ...
        //若放在其他版块会有一些小问题
        jFrame.add(this, BorderLayout.CENTER);//添加到框架布局的中间部分
        ...
        String[] userMessage = {"pic", "昵称：黃康远", "性别：男", "等级：新手"};
